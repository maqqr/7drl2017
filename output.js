      ...
      return function (v1) {
          if (v1 instanceof Potion && v1.value0.effect instanceof Healing) {
              var heal = function (v2) {
                  var $120 = (v2.stats.hp + 5 | 0) > v2.stats.hpMax;
                  if ($120) {
                  ...
                  throw new Error("Failed pattern match at Rogue line 314, column 29 - line 314, column 109: " + [ $120.constructor.name ]);
              };
              var pl = function (v2) {
                  var $125 = {};
                  for (var $126 in v2) {
                  ...
                  $125.stats = (function () {
                      var $122 = {};
                      for (var $123 in v2.stats) {
                          if ({}.hasOwnProperty.call(v2.stats, $123)) {
                              $122[$123] = v2["stats"][$123];
                          };
                      };
                      $122.hp = heal(v2);
                      return $122;
          ...
          if (v1 instanceof Potion && v1.value0.effect instanceof Warming) {
              var warm = (function () {
                  ...
                  throw new Error("Failed pattern match at Rogue line 318, column 16 - line 318, column 80: " + [ $133.constructor.name ]);
              })();
              var $134 = {};
              for (var $135 in v) {
          ...
          return function (v2) {
              ...
              if (v2.creatureType instanceof Player) {
                  var dmgToPlayer = (function () {
                      var $312 = playerArmour(v) >= dmg(v1)(Data_Maybe.Nothing.value);
                      if ($312) {
                          return 1;
                      };
                      if (!$312) {
                      ...
                      throw new Error("Failed pattern match at Rogue line 365, column 23 - line 365, column 108: " + [ $312.constructor.name ]);
                  })();
                  var $316 = {};
                  for (var $317 in v2) {
