...
(function(exports) {
  ...
  var tileIcon = function (v) {
      ...
      if (v instanceof Puddle) {
          ...
          throw new Error("Failed pattern match at Rogue line 130, column 30 - line 131, column 1: " + [ v.value0.frozen.constructor.name ]);
      };
      ...
      return function (t) {
          return function (p) {
              ...
              $82.level = (function () {
                  ...
                  $79.tiles = Data_Maybe.fromMaybe(v.level.tiles)(Data_Array.insertAt((p.y * v.level.width | 0) + p.x | 0)(t)(v.level.tiles));
                  return $79;
              })();
              return $82;
          };
  ...
  var setLevelTile = function (level) {
      return function (t) {
          return function (p) {
              ...
              $90.tiles = Data_Maybe.fromMaybe(level.tiles)(Data_Array.insertAt((p.y * level.width | 0) + p.x | 0)(t)(level.tiles));
              return $90;
          };
      };
  };
  ...
  var frozenColor = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 138, column 1 - line 139, column 1: " + [ v.constructor.name ]);
  };
