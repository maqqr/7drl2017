...
(function(exports) {
  ...
  var setLevelTile = function (level) {
      return function (t) {
          return function (p) {
              var $94 = {};
              for (var $95 in level) {
                  if ({}.hasOwnProperty.call(level, $95)) {
                      $94[$95] = level[$95];
                  };
              };
              $94.tiles = Data_Maybe.fromMaybe(level.tiles)(Data_Array.updateAt((p.y * level.width | 0) + p.x | 0)(t)(level.tiles));
              return $94;
          };
      };
  };
  var setTile = function (v) {
      return function (t) {
          return function (p) {
              ...
              $100.level = setLevelTile(v.level)(t)(p);
              return $100;
          };
      };
  };
      ...
      return function (v1) {
          if (v1 instanceof Potion && v1.value0.effect instanceof Healing) {
              var heal = function (v2) {
                  var $106 = (v2.stats.hp + 5 | 0) > v2.stats.hpMax;
                  if ($106) {
                  ...
                  throw new Error("Failed pattern match at Rogue line 271, column 29 - line 271, column 109: " + [ $106.constructor.name ]);
              };
              var pl = function (v2) {
                  var $111 = {};
                  for (var $112 in v2) {
                  ...
                  $111.stats = (function () {
                      var $108 = {};
                      for (var $109 in v2.stats) {
                          if ({}.hasOwnProperty.call(v2.stats, $109)) {
                              $108[$109] = v2["stats"][$109];
                          };
                      };
                      $108.hp = heal(v2);
                      return $108;
          ...
          if (v1 instanceof Potion && v1.value0.effect instanceof Warming) {
              var warm = (function () {
                  ...
                  throw new Error("Failed pattern match at Rogue line 275, column 16 - line 275, column 80: " + [ $119.constructor.name ]);
              })();
              var $120 = {};
              for (var $121 in v) {
      ...
      return function (v1) {
          return function (v2) {
              if (v1 instanceof Armour && v2 === 1) {
                  ...
                  $174.equipment = (function () {
                      var $171 = {};
                      for (var $172 in v.equipment) {
                          if ({}.hasOwnProperty.call(v.equipment, $172)) {
                              $171[$172] = v["equipment"][$172];
                          };
                      };
                      $171.cloak = isCorrectArmour(new Armour(v1.value0))(v1.value0.armourType)(1);
                      return $171;
                  })();
                  return $174;
              };
              if (v1 instanceof Armour && v2 === 2) {
                  ...
                  $181.equipment = (function () {
                      var $178 = {};
                      for (var $179 in v.equipment) {
                          if ({}.hasOwnProperty.call(v.equipment, $179)) {
                              $178[$179] = v["equipment"][$179];
                          };
                      };
                      $178.chest = isCorrectArmour(new Armour(v1.value0))(v1.value0.armourType)(2);
                      return $178;
                  })();
                  return $181;
              };
              if (v1 instanceof Armour && v2 === 3) {
                  ...
                  $188.equipment = (function () {
                      var $185 = {};
                      for (var $186 in v.equipment) {
                          if ({}.hasOwnProperty.call(v.equipment, $186)) {
                              $185[$186] = v["equipment"][$186];
                          };
                      };
                      $185.hands = isCorrectArmour(new Armour(v1.value0))(v1.value0.armourType)(3);
                      return $185;
                  })();
                  return $188;
              };
              if (v2 === 4) {
                  ...
                  $195.equipment = (function () {
                      ...
                      $192.weapon = new Data_Maybe.Just(v1);
                      return $192;
                  })();
                  return $195;
              };
  ...
  var getAPPool = function (t) {
      return function (v) {
          ...
          var $202 = Data_Eq.eq(eqTheme)(p.theme)(t);
          if ($202) {
          ...
          throw new Error("Failed pattern match at Rogue line 181, column 23 - line 184, column 65: " + [ $202.constructor.name ]);
      };
  };
  var getWPPool = function (t) {
      return function (v) {
          ...
          var $205 = Data_Eq.eq(eqTheme)(p.theme)(t);
          if ($205) {
          ...
          throw new Error("Failed pattern match at Rogue line 167, column 23 - line 170, column 65: " + [ $205.constructor.name ]);
      };
  };
  ...
  var attack = function (v) {
      return function (v1) {
          ...
          $221.stats = (function () {
              var $218 = {};
              for (var $219 in v1.stats) {
                  if ({}.hasOwnProperty.call(v1.stats, $219)) {
                      $218[$219] = v1["stats"][$219];
                  };
              };
              $218.hp = v1.stats.hp - dmg(v) | 0;
              return $218;
          })();
          return $221;
      };
  ...
  var addItem = function (v) {
      return function (v1) {
          if (v1 instanceof Data_Maybe.Just) {
              ...
              $231.inv = Data_Array.snoc(v.inv)(v1.value0);
              return $231;
          };
          return v;
      };
  ...
  var unEquip = function (v) {
      return function (v1) {
          if (v1 === 1) {
              var $240 = {};
              for (var $241 in v) {
                  if ({}.hasOwnProperty.call(v, $241)) {
                      $240[$241] = v[$241];
                  };
              };
              $240.equipment = (function () {
                  var $237 = {};
                  for (var $238 in v.equipment) {
                      if ({}.hasOwnProperty.call(v.equipment, $238)) {
                          $237[$238] = v["equipment"][$238];
                      };
                  };
                  $237.cloak = Data_Maybe.Nothing.value;
                  return $237;
              })();
              $240.player = addItem(v.player)(v.equipment.cloak);
              return $240;
          };
          if (v1 === 2) {
              var $246 = {};
              ...
              $246.equipment = (function () {
                  ...
                  $243.chest = Data_Maybe.Nothing.value;
                  return $243;
              })();
              $246.player = addItem(v.player)(v.equipment.chest);
              return $246;
          };
          if (v1 === 3) {
              var $252 = {};
              ...
              $252.equipment = (function () {
                  ...
                  $249.hands = Data_Maybe.Nothing.value;
                  return $249;
              })();
              $252.player = addItem(v.player)(v.equipment.hands);
              return $252;
          };
          if (v1 === 4) {
              var $258 = {};
              ...
              $258.equipment = (function () {
                  ...
                  $255.weapon = Data_Maybe.Nothing.value;
                  return $255;
              })();
              $258.player = addItem(v.player)(v.equipment.weapon);
              return $258;
          };
          return v;
      };
