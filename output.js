  ...
  var setLevelTile = function (level) {
      return function (t) {
          return function (p) {
              var $81 = {};
              for (var $82 in level) {
                  if ({}.hasOwnProperty.call(level, $82)) {
                      $81[$82] = level[$82];
                  };
              };
              $81.tiles = Data_Maybe.fromMaybe(level.tiles)(Data_Array.insertAt((p.y * level.width | 0) + p.x | 0)(t)(level.tiles));
              return $81;
          };
      };
  };
  var setTile = function (v) {
      return function (t) {
          return function (p) {
              ...
              $87.level = setLevelTile(v.level)(t)(p);
              return $87;
          };
      };
  };
