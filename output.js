...
(function(exports) {
  ...
  var weaponTypeStats = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 307, column 1 - line 307, column 59: " + [ v.constructor.name ]);
  };
  var weaponTypeName = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 302, column 1 - line 303, column 1: " + [ v.constructor.name ]);
  };
  ...
  var weaponPrefixName = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 314, column 1 - line 315, column 1: " + [ v.constructor.name ]);
  };
  ...
  var tileIcon = function (v) {
      ...
      if (v instanceof Puddle) {
          ...
          throw new Error("Failed pattern match at Rogue line 196, column 30 - line 197, column 1: " + [ v.value0.frozen.constructor.name ]);
      };
  ...
  var themeName = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 228, column 1 - line 229, column 1: " + [ v.constructor.name ]);
  };
  var showTile = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 157, column 5 - line 158, column 5: " + [ v.constructor.name ]);
  });
  ...
  var setLevelTile = function (level) {
      return function (t) {
          return function (p) {
              var $136 = {};
              for (var $137 in level) {
                  if ({}.hasOwnProperty.call(level, $137)) {
                      $136[$137] = level[$137];
                  };
              };
              $136.tiles = Data_Maybe.fromMaybe(level.tiles)(Data_Array.updateAt((p.y * level.width | 0) + p.x | 0)(t)(level.tiles));
              return $136;
          };
      };
  };
  var setTile = function (v) {
      return function (t) {
          return function (p) {
              ...
              $142.level = setLevelTile(v.level)(t)(p);
              return $142;
          };
      };
  };
  ...
  var potionName = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 378, column 1 - line 379, column 1: " + [ v.constructor.name ]);
  };
      ...
      return function (v1) {
          if (v1 instanceof Potion && v1.value0.effect instanceof Healing) {
              var heal = function (v2) {
                  ...
                  $152.stats = (function () {
                      var $149 = {};
                      for (var $150 in v2.stats) {
                          if ({}.hasOwnProperty.call(v2.stats, $150)) {
                              $149[$150] = v2["stats"][$150];
                          };
                      };
                      $149.hp = Data_Ord.max(Data_Ord.ordInt)(v2.stats.hp + 5 | 0)(v2.stats.hpMax);
                      return $149;
                  })();
                  return $152;
              };
  ...
  var min$prime = function (x) {
      return function (y) {
          ...
          throw new Error("Failed pattern match at Rogue line 448, column 1 - line 450, column 20: " + [ x.constructor.name, y.constructor.name ]);
      };
  };
  var max$prime = function (x) {
      return function (y) {
          ...
          throw new Error("Failed pattern match at Rogue line 453, column 1 - line 455, column 20: " + [ x.constructor.name, y.constructor.name ]);
      };
  };
  ...
  var frozenColor = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 207, column 1 - line 208, column 1: " + [ v.constructor.name ]);
  };
      ...
      return function (v1) {
          return function (v2) {
              if (v1 instanceof Armour && v2 === 1) {
                  ...
                  $238.equipment = (function () {
                      var $235 = {};
                      for (var $236 in v.equipment) {
                          if ({}.hasOwnProperty.call(v.equipment, $236)) {
                              $235[$236] = v["equipment"][$236];
                          };
                      };
                      $235.cloak = isCorrectArmour(new Armour(v1.value0))(v1.value0.armourType)(1);
                      return $235;
                  })();
                  return $238;
              };
              if (v1 instanceof Armour && v2 === 2) {
                  ...
                  $245.equipment = (function () {
                      ...
                      $242.chest = isCorrectArmour(new Armour(v1.value0))(v1.value0.armourType)(2);
                      return $242;
                  })();
                  return $245;
              };
              if (v1 instanceof Armour && v2 === 3) {
                  ...
                  $252.equipment = (function () {
                      ...
                      $249.hands = isCorrectArmour(new Armour(v1.value0))(v1.value0.armourType)(3);
                      return $249;
                  })();
                  return $252;
              };
              if (v2 === 4) {
                  ...
                  $259.equipment = (function () {
                      ...
                      $256.weapon = new Data_Maybe.Just(v1);
                      return $256;
                  })();
                  return $259;
              };
  ...
  var deleteItem = function (v) {
      return function (i) {
          ...
          $270.inv = Data_Maybe.fromMaybe(v.inv)(Data_Array.deleteAt(i)(v.inv));
          return $270;
      };
  };
  ...
  var armourTypeStats = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 347, column 1 - line 347, column 53: " + [ v.constructor.name ]);
  };
  var armourTypeName = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 272, column 1 - line 273, column 1: " + [ v.constructor.name ]);
  };
  ...
  var armourPrefixName = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 354, column 1 - line 355, column 1: " + [ v.constructor.name ]);
  };
  var itemName = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 277, column 1 - line 277, column 86: " + [ v.constructor.name ]);
  };
  ...
  var addItem = function (v) {
      return function (v1) {
          if (v1 instanceof Data_Maybe.Just) {
              ...
              $312.inv = Data_Array.snoc(v.inv)(v1.value0);
              return $312;
          };
          return v;
      };
  ...
  var unEquip = function (v) {
      return function (v1) {
          if (v1 === 1) {
              ...
              $321.equipment = (function () {
                  var $318 = {};
                  for (var $319 in v.equipment) {
                      if ({}.hasOwnProperty.call(v.equipment, $319)) {
                          $318[$319] = v["equipment"][$319];
                      };
                  };
                  $318.cloak = Data_Maybe.Nothing.value;
                  return $318;
              })();
              $321.player = addItem(v.player)(v.equipment.cloak);
              return $321;
          };
          if (v1 === 2) {
              var $327 = {};
              ...
              $327.equipment = (function () {
                  var $324 = {};
                  for (var $325 in v.equipment) {
                      if ({}.hasOwnProperty.call(v.equipment, $325)) {
                          $324[$325] = v["equipment"][$325];
                      };
                  };
                  $324.chest = Data_Maybe.Nothing.value;
                  return $324;
              })();
              $327.player = addItem(v.player)(v.equipment.chest);
              return $327;
          };
          if (v1 === 3) {
              var $333 = {};
              for (var $334 in v) {
                  if ({}.hasOwnProperty.call(v, $334)) {
                      $333[$334] = v[$334];
                  };
              };
              $333.equipment = (function () {
                  var $330 = {};
                  for (var $331 in v.equipment) {
                      if ({}.hasOwnProperty.call(v.equipment, $331)) {
                          $330[$331] = v["equipment"][$331];
                      };
                  };
                  $330.hands = Data_Maybe.Nothing.value;
                  return $330;
              })();
              $333.player = addItem(v.player)(v.equipment.hands);
              return $333;
          };
          if (v1 === 4) {
              var $339 = {};
              ...
              $339.equipment = (function () {
                  var $336 = {};
                  for (var $337 in v.equipment) {
                      if ({}.hasOwnProperty.call(v.equipment, $337)) {
                          $336[$337] = v["equipment"][$337];
                      };
                  };
                  $336.weapon = Data_Maybe.Nothing.value;
                  return $336;
              })();
              $339.player = addItem(v.player)(v.equipment.weapon);
              return $339;
          };
          return v;
      };
          ...
          return function (v1) {
              return function (v2) {
                  if (v1.creatureType instanceof Player) {
                      ...
                      var $352 = {};
                      for (var $353 in v2) {
                          if ({}.hasOwnProperty.call(v2, $353)) {
                              $352[$353] = v2[$353];
                          };
                      };
                      $352.stats = (function () {
                          var $349 = {};
                          for (var $350 in v2.stats) {
                              if ({}.hasOwnProperty.call(v2.stats, $350)) {
                                  $349[$350] = v2["stats"][$350];
                              };
                          };
                          $349.hp = v2.stats.hp - d | 0;
                          return $349;
                      })();
                      return $352;
                  };
                  if (v2.creatureType instanceof Player) {
                      ...
                      var $360 = {};
                      for (var $361 in v2) {
                          if ({}.hasOwnProperty.call(v2, $361)) {
                              $360[$361] = v2[$361];
                          };
                      };
                      $360.stats = (function () {
                          var $357 = {};
                          for (var $358 in v2.stats) {
                              if ({}.hasOwnProperty.call(v2.stats, $358)) {
                                  $357[$358] = v2["stats"][$358];
                              };
                          };
                          $357.hp = v2.stats.hp - d | 0;
                          return $357;
                      })();
                      return $360;
                  };
                  ...
                  $368.stats = (function () {
                      var $365 = {};
                      for (var $366 in v2.stats) {
                          if ({}.hasOwnProperty.call(v2.stats, $366)) {
                              $365[$366] = v2["stats"][$366];
                          };
                      };
                      $365.hp = v2.stats.hp - d | 0;
                      return $365;
                  })();
                  return $368;
              };
