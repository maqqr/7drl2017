...
(function(exports) {
      ...
      return function (v1) {
          return function (v2) {
              if (v1.creatureType instanceof Player) {
                  ...
                  $312.stats = (function () {
                      var $309 = {};
                      for (var $310 in v2.stats) {
                          if ({}.hasOwnProperty.call(v2.stats, $310)) {
                              $309[$310] = v2["stats"][$310];
                          };
                      };
                      $309.hp = v2.stats.hp - dmg(v1)(v.equipment.weapon) | 0;
                      return $309;
                  })();
                  return $312;
              };
              if (v2.creatureType instanceof Player) {
                  var dmgToPlayer = dmg(v1)(Data_Maybe.Nothing.value) - playerArmour(v) | 0;
                  var $320 = {};
                  for (var $321 in v2) {
                  ...
                  $320.stats = (function () {
                      var $317 = {};
                      for (var $318 in v2.stats) {
                          if ({}.hasOwnProperty.call(v2.stats, $318)) {
                              $317[$318] = v2["stats"][$318];
                          };
                      };
                      $317.hp = v2.stats.hp - dmgToPlayer | 0;
                      return $317;
                  })();
                  return $320;
              };
              ...
              $328.stats = (function () {
                  var $325 = {};
                  for (var $326 in v2.stats) {
                      if ({}.hasOwnProperty.call(v2.stats, $326)) {
                          $325[$326] = v2["stats"][$326];
                      };
                  };
                  $325.hp = v2.stats.hp - dmg(v1)(Data_Maybe.Nothing.value) | 0;
                  return $325;
              })();
              return $328;
          };
  ...
  var cold = function (v) {
      ...
      $333.coldStatus = (v.coldStatus + 1 | 0) - playerColdRes(v) | 0;
      return $333;
  };
