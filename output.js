          ...
          return Control_Bind.bind(Random.randomBind)(randomWeapon)(function (v) {
              return Control_Bind.bind(Random.randomBind)(randomArmour)(function (v1) {
                  return Control_Bind.bind(Random.randomBind)(randomPotion)(function (v2) {
                      return Control_Bind.bind(Random.randomBind)(Random.selectOne([ v, v1, v2 ]))(function (v3) {
                          if (v3 instanceof Data_Maybe.Just) {
                              return Control_Applicative.pure(Random.randomApplicative)(v3.value0);
                          };
                          if (v3 instanceof Data_Maybe.Nothing) {
                              return Partial_Unsafe.unsafeCrashWith("empty array");
                          };
                          throw new Error("Failed pattern match at ContentGenerator line 42, column 5 - line 45, column 5: " + [ v3.constructor.name ]);
                      });
                  });
              });
          });
