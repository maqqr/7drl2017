...
(function(exports) {
  ...
  var tileIcon = function (v) {
      ...
      if (v instanceof Puddle) {
          ...
          throw new Error("Failed pattern match at Rogue line 98, column 31 - line 99, column 1: " + [ v.value0.frozen.constructor.name ]);
      };
  ...
  var setTile = function (v) {
      return function (t) {
          return function (p) {
              ...
              $34.level = (function () {
                  var $31 = {};
                  for (var $32 in v.level) {
                      if ({}.hasOwnProperty.call(v.level, $32)) {
                          $31[$32] = v["level"][$32];
                      };
                  };
                  $31.tiles = Data_Maybe.fromMaybe(v.level.tiles)(Data_Array.insertAt((p.y * v.level.width | 0) + p.x | 0)(t)(v.level.tiles));
                  return $31;
              })();
              return $34;
          };
  ...
  var frozenColor = function (v) {
      ...
      throw new Error("Failed pattern match at Rogue line 106, column 1 - line 107, column 1: " + [ v.constructor.name ]);
  };
  ...
  var deleteItem = function (v) {
      return function (i) {
          ...
          $82.inv = Data_Maybe.fromMaybe(v.inv)(Data_Array.deleteAt(i)(v.inv));
          return $82;
      };
  };
  var defaultStats = {
  ...
  var addItem = function (v) {
      return function (i) {
          ...
          $87.inv = Data_Array.snoc(v.inv)(i);
          return $87;
      };
  };
